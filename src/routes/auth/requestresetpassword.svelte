...
<div class="flex flex-col items-center max-w-sm max-w-screen-xsm mx-auto">
	<div class="bg-white p-6 ml-1.5 sm:ml-0 rounded shadow-md text-black w-5/6 sm:w-full">
		<form action="/api/auth/resetpassword" method="POST">
			...
			/>
			{#if systemError}
				<h2 class="mt-5">There was a System error trying to check the address.</h2>
