<h1 class="sm:mt-5 mt-10">Strengthening Our Community</h1>
<h2 class="text-center">Terms of Use June 2022</h2>
<section class="flex flex-col mx-auto h-full max-w-3xl text-gray-800">
	<p class="m-1">
		Thanks for taking the time to read our Terms of Use regarding your use of
		the Strengthen Our Community website. These terms define your rights and
		responsibilities when using the website.
	</p>
	<p class="m-1">
		The website is for use by households within the designated geographical
		area.
	</p>
	<h2 class="title-font font-bold text-lg text-orange-600 m-1">Definitions</h2>
	<div class="mx-5">
		<p class="m-1">
			<strong>Services</strong> means the information provided on the website, the
			collection and representation of the data you provide.
		</p>
		<p class="m-1">
			<strong>The Website</strong> means the website [insert website details]
		</p>
		<p class="m-1">
			<strong>We / Us etc</strong> means The Strengthening Our Community Project
			Team and Burrell Creek Youth and Community Association.
		</p>
		<p class="m-1">
			<strong>You</strong> means the person who registered to use the website.
		</p>
	</div>
	...
	<p class="m-1">
		Storage of the data collected through the Strengthen Our Community website
	...
	<p class="m-1">
		The Website is made available for your use on your acceptance and compliance
	...
	<p class="m-1">
		You provide data to this website with the knowledge that it will be made
		available to emergency services for the duration of an emergency situation.
	</p>
	<p class="m-1">
		You agree that you will use this website in accordance with all applicable
		local, state, national and international laws, rules and regulations.
	</p>
	<p class="m-1">
		You agree that you will not use, nor will you allow or authorise any third
	...
	<p class="m-1">
		We reserve the right to refuse, or terminate, service to anyone at any time
	...
	<p class="m-1">
		We hold the intellectual property rights and copyright to the content of
	...
	<p class="m-1">
		If you wish to use content, images or other of our intellectual property,
	...
	<p class="m-1">
		Use of information you have provided us with, or that we have collected and
	...
	<p class="m-1">
		All personal information you give us will be dealt with in a confidential
