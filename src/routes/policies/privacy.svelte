...
<section class="flex flex-col mx-auto h-full max-w-3xl text-gray-800">
	<p class="m-1">Last updated: 1/7/22</p>
	<h2 class="title-font font-bold text-lg text-orange-600 m-1">1. Overview</h2>
	<div class="mx-5">
		<p class="m-1">
			(a) As responsible data custodians we are committed to protecting your
			personal information, collected as part of 'Strengthening Our Community'
			(the Project).
		</p>
		<p class="m-1">
			(b) This Privacy Policy outlines how we collect, use, store and disclose
		...
		<p class="m-1">
			(c) We take our security obligations seriously and your personal
	...
	<div class="mx-5">
		<p class="m-1">
			(a) The Project survey will only collect information that is necessary for
			one or more of our functions or activities.
		</p>
		<p class="m-1">
			(b) The Project will advise individuals of the purpose for which their
			personal information is collected.
		</p>
		<p class="m-1">
			(c) If the Project collects sensitive information (as defined under the
		...
		<p class="m-1">
			(d) Where an individual chooses not to provide requested information, the
	...
	<p class="m-1">
		The Project will only disclose personal information in accordance with the
		Act.
	</p>
	...
	<p class="m-1">
		As the Project is committed to protecting the privacy of individuals, we
	...
	<p class="m-1">
		Appropriate action (which may include disciplinary or legal action) will be
		taken in such cases.
	</p>
	<h2 class="title-font font-bold text-lg text-orange-600 m-1">
	...
	<div class="mx-5">
		<p class="m-1">
			(a) You have a right to access your personal information, subject to
		...
		<p class="m-1">
			(b) Where we cannot provide you with access to all of your personal
		...
		<p class="m-1">
			(c) If at any time you believe that information we hold about you is
	...
	<div class="mx-5">
		<p class="m-1">
			(a) Our goal is to protect the personal information collected by the
		...
		<p class="m-1">
			(b) We will monitor and implement appropriate technical advances or
	...
	<p class="m-1">
		We will take all reasonable steps to ensure that the data we collect, use or
	...
	<p class="m-1">
		The Project will make our privacy policy available upon request. This policy
	...
	<p class="m-1 mb-3">
		If you have any concerns or complaints regarding the way in which we have
